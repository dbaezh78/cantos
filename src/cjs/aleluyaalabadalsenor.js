// Titulo	
let titulo = "ALELUYA, ALABAD AL SEÑOR";
let salmo = "Salmo 150";
let dbnos = "13";      //Numero del libro

// Definir variables con la parte de la Asamble	
let Asamblea1 = "¡ALELUYA, ALELUYA, ALELUYA!";
let Asamblea2 = "¡ALELUYA, ALELUYA, ALELUYA!";
let Asamblea3 = "¡ALELUYA, ALELUYA, ALELUYA!";
let Asamblea4 = "¡ALELUYA, ALELUYA, ALELUYA!";
let Asamblea5 = "¡ALELUYA, ALELUYA, ALELUYA!";
let Asamblea6 = "¡ALELUYA, ALELUYA, ALELUYA!";
let Asamblea7 = "¡TODO SER ALABE AL SEÑOR,";
let Asamblea8 = "ALABE, ALABE AL SEÑOR!";
let Asamblea9 = "¡ALELUYA, ALELUYA, ALELUYA!";
let Asamblea10 = "¡ALELUYA, ALELUYA, ALELUYA!";


// Definir variables con la parte de la Asamble	
let Cantor1 = "Alabad al Señor en su templo,";
let Cantor2 = "alabadlo en su fuerte firmamento,";
let Cantor3 = "alabadlo por sus obras estupendas,";
let Cantor4 = "alabadlo por su inmensa grandeza.";
let Cantor5 = "Alabadlo al son de trompetas,";
let Cantor6 = "alabadlo con arpas y guitarras,";
let Cantor7 = "alabadlo con tambores y con danzas,";
let Cantor8 = "alabadlo con trompas y flautas.";
let Cantor9 = "Alabadlo con platillos sonoros,";
let Cantor10 = "alabadlo con platillos vibrantes.";
