...
let Asamblea1 = "ALELUYA,ALELUYA,ALELUYA,ALELUYA.";
let Asamblea2 = "ALELUYA,ALELUYA,ALELUYA,ALELUYA.";
...
let Asamblea7 = "ALELUYA,ALELUYA,ALELUYA.";
let Asamblea8 = "ALELUYA,ALELUYA,ALELUYA.";

// Definir variables con la parte de la Asamble	
let Cantor1 = "Aleluya, aleluya, aleluya, aleluya.";
let Cantor2 = "Yo soy la vid, vosotros los sarmientos.";
let Cantor3 = "El que permanece en mí y yo en él,";
let Cantor4 = "ése da fruto abundante. ";
let Cantor5 = "Con la música del «Aleluya, ya llegó el Reino».";
let Cantor6 = "Yo soy la vid, vosotros los sarmientos.";
let Cantor7 = "El que permanece en mí y yo en él,";
let Cantor8 = "ése da fruto abundante.";
let Cantor9 = "Aleluya, aleluya, aleluya.";
let Cantor10 = "Yo soy la vid, vosotros los sarmientos.";
let Cantor11 = "El que permanece en mí y yo en él,";
let Cantor12 = "ése da fruto abundante. ";
