	// Titulo
	let titulo = "A TI, SEÑOR, LEVANTO MI ALMA";
	let salmo = "Salmo 25 (24)";
	let dbnos = "25";	//Numero del libro
	...
	let Cantor2 = "¡no triunfen sobre mí mis enemigos!";
	let Cantor3 = "Muéstrame, Señor, tu camino,";
	let Cantor4 = "enséñame, Señor, tu sendero.";
	let Cantor5 = "Acuérdate, Señor, de tu ternura,";
	let Cantor6 = "de tu inmensa compasión, que son de siempre.";
	let Cantor7 = "De mis pecados, Señor, no te acuerdes,";
	let Cantor8 = "acuérdate, Señor, que eres misericordia.";
	let Cantor9 = "Rocíame, Señor, de tu misericordia.";
	let Cantor10 = "Sumérgeme, Señor, en tu misericordia.";
