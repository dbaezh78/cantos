	// Titulo
	let titulo = "ACLAMAD AL SEÑOR";
	let salmo = "Salmo 100 (99)";
	let dbnos = "28";	//Numero del libro

    // Definir variables con la parte de la Asamble
	
	let Asamblea1 = "¡ACLAMAD AL SEÑOR,";
	let Asamblea2 = "TODA LA TIERRA,";
	let Asamblea3 = "SERVID AL SEÑOR CON ALEGRÍA!";
	let Asamblea4 = "¡ACLAMAD AL SEÑOR,";
	let Asamblea5 = "TODA LA TIERRA,";
	let Asamblea6 = "SERVID AL SEÑOR CON ALEGRÍA!";
	let Asamblea7 = "¡ACLAMAD AL SEÑOR,";
	let Asamblea8 = "TODA LA TIERRA,";
	let Asamblea9 = "SERVID AL SEÑOR CON ALEGRÍA!";
	let Asamblea10 = "¡ACLAMAD AL SEÑOR,";
	let Asamblea11 = "TODA LA TIERRA,";
	let Asamblea12 = "SERVID AL SEÑOR CON ALEGRÍA!";
	let Asamblea13 = "¡ACLAMAD AL SEÑOR,";
	let Asamblea14 = "TODA LA TIERRA,";
	let Asamblea15 = "SERVID AL SEÑOR CON ALEGRÍA!";
	let Asamblea16 = "¡ACLAMAD AL SEÑOR,";
	let Asamblea17 = "TODA LA TIERRA,";
	let Asamblea18 = "SERVID AL SEÑOR CON ALEGRÍA!";

	// Definir variables con la parte del Solista
	let Cantor1 = "¡Acercaos a él";
	let Cantor2 = "con gritos de júbilo!";
	let Cantor3 = "Porque el Señor es nuestro Dios,";
	let Cantor4 = "y nosotros su pueblo.";
	let Cantor5 = "¡Entrad por sus puertas";
	let Cantor6 = "con himnos de alegría!";
	let Cantor7 = "¡Bendecid su nombre,";
	let Cantor8 = "dándole gracias!";
	let Cantor9 = "Porque es bueno el Señor,";
	let Cantor10 = "es eterno su amor con nosotros";
