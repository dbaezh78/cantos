	...
	let Asamblea2 = "¡HA RESUCITADO!";
	let Asamblea3 = "Y NOS PRECEDE EN GALILEA,";
	let Asamblea4 = "Y NOS PRECEDE EN GALILEA.";
	let Asamblea5 = "SÍ QUE ES CIERTO,";
	let Asamblea6 = "CRISTO HA RESUCITADO.";
	let Asamblea7 = "SÍ QUE ES CIERTO,";
	let Asamblea8 = "CRISTO HA RESUCITADO.";
	let Asamblea9 = "Y NOS PRECEDE EN GALILEA,";
	let Asamblea10 = "Y NOS PRECEDE EN GALILEA.";

	// Definir variables con la parte del Solista
	let Cantor1 = "A la víctima pascual";
	let Cantor2 = "ofrecemos hoy";
	let Cantor3 = "el sacrificio de alabanza.";
	let Cantor4 = "El cordero ha redimido el rebaño,";
	let Cantor5 = "el inocente ha reconciliado";
	let Cantor6 = "los pecadores al Padre.";
	let Cantor7 = "Muerte y vida se han enfrentado";
	let Cantor8 = "en un prodigioso duelo";
	let Cantor9 = "el autor de la Vida estaba muerto,";
	let Cantor10 = "mas ahora está vivo y triunfa.";
	let Cantor11 = "Dinos tú, María:";
	let Cantor12 = "¿qué has visto en el camino?";
	let Cantor13 = "«La tumba de Cristo vacía,";
	let Cantor14 = "la Gloria del Señor y vivo Cristo,";
