...
function renderizarAcordes(contenedor, acordesData) {
    // Asegúrate de que el contenedor tenga la clase line-container
    contenedor.classList.add('line-container');
    
    // Crea el contenedor de acordes
    ...
    acordesData.forEach(acorde => {
        ...
        if (acorde.extension) {
            ...
            ext.innerHTML = acorde.extension;
            ext.style.marginLeft = '2px';
    ...
    // Inserta los acordes al principio del contenedor
    contenedor.insertBefore(divAcordes, contenedor.firstChild);
}
