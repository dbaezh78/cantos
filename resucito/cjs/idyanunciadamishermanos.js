...
const pcelular = {
    ...
    /* 3*/      [ac("Re", "cp294","m"), ac("La","cp560","m")],
    /* 4*/      [ac("Mi", "cp194",""), ac("La","cp402","m")],
    /* 5*/      [ac("Fa", "cp81",""), ac("Mi","cp194","")],
    /* 6*/      [ac("Do", "cp14",""), ac("Sol","cp453","")],
    /* 7*/      [ac("Do", "cp318","")],
    /* 8*/      [ac("Do", "cp4",""), ac("Sol","cp351","")],
    /* 9*/      [ac("Do", "cp205","")],
    /* 10*/      [ac("La", "cp93","m"), ac("Mi","cp558","")],
    /* 11*/      [ac("La", "cp405","m")],
    /* 12*/      [ac("Fa", "cp0","")],
