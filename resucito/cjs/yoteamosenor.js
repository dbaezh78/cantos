...
╚════════════════════════════════════════════════════════════════╝  */
cantorAcordes: [
/* 1*/      [ac("Re", "cp14",""), ac("Fa#","cp90",""), ac("Si","cp150","m")],
/* 2*/      [ac("Sol", "cp14",""), ac("Fa#","cp90","")],
/* 3*/      [ac("Sol", "cp14",""), ac("Fa#","cp90","")],
/* 4*/      [ac("Re", "cp14",""), ac("Si","cp90","m")],
/* 5*/      [ac("Sol", "cp",""), ac("Re","cp90","")],
/* 6*/      [ac("La", "cp14",""), ac("Sol","cp90","")],
/* 7*/      [ac("Re", "cp14","")],
/* 8*/      [ac("Fa#", "cp14","")],
/* 9*/      [ac("Sim", "cp14","")],
/* 10*/      [ac("La", "cp14",""), ac("Sol","cp90","")],
/* 11*/      [ac("Fa#", "cp14","")],
/* 12*/      [ac("Sol", "cp14",""), ac("Fa#","cp90","")],
/* 13*/      [ac("Sol", "cp14",""), ac("Fa#","cp90","")],
/* 14*/      [ac("Sol", "cp14",""), ac("Fa#","cp90","")],
/* 15*/      [ac("La", "cp14",""), ac("Fa#","cp90","")],
/* 16*/      [ac("La", "cp14",""), ac("Fa#","cp90","")],
/* 17*/      [ac("Sol", "cp14","")],
/* 18*/      [ac("Fa#", "cp14","")],
/* 19*/      [ac("Re", "cp14",""), ac("Fa#","cp90",""), ac("Si","cp150","m")],
/* 20*/      [ac("Sol", "cp14",""), ac("Fa#","cp90","")],
/* 21*/      [ac("Sol", "cp14",""), ac("Fa#","cp90","")],
/* 22*/      [ac("Re", "cp14",""), ac("Si","cp90","m")],
/* 23*/      [ac("Sol", "cp14",""), ac("Re","cp90","")],
/* 24*/      [ac("La", "cp14",""), ac("Sol","cp90","")],
/* 25*/      [ac("Si", "cp14","m"), ac("La","cp90","")],
/* 26*/      [ac("Si", "cp14","m"), ac("La","cp90",""), ac("Si","cp150","m")],
/* 27*/      [ac("Sol", "cp14",""), ac("Fa#","cp90",""), ac("Sol","cp150",""), ac("Fa#","cp250","")],
/* 28*/      [ac("Si", "cp14","m"), ac("Sol","cp90",""), ac("La","cp150","")],
/* 29*/      [ac("Sol", "cp14",""), ac("Fa#","cp90",""), ac("Sol","cp150",""), ac("Fa#","cp250","")],
/* 30 */   [ac("", "cp0","")],
],/*
╔════════════════════════════════════════════════════════════════╗
